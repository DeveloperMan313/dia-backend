    ...
    "paths": {
        ...
        "/light-requests/cart": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success. For unauthorized/empty cart: {\\\\\"request_id\\\\\": 0, \\\\\"item_count\\\\\": -1}",
                        "schema": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.FinishRequestRequest"
                        }
                    }
                ],
                "responses": {
